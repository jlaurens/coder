...
\group_begin:
\makeatletter
\cs_set:Npn \CDR_tag_provide:n #1 {
  \exp_args:NNf
  \regex_extract_once:NnNTF \c_CDR_provide_regex {
    ...
    \clist_map_inline:nn {
      ...
      \CDR_tag_keys_if_exist:nnF { ##1 } { __initialize } {
\CDR@Debug{Debug.CDR.provided:NO CDR@Tags/tag/default/__initialize }
        ...
        \CDR_tag_keys_define:nn { ##1 } {
          __initialize __ .meta:n = {},
          ##1 .value_required:n = true,
        }
\CDR@Debug{Debug.CDR.provided:\CDR_tag_module:n {##1} }
      }
...
\CDR@Debug{Debug.CDR.provided: \CDR_tag_module:n { ##1 } / \l_CDR_tl = ...}
        }
      }
    }
  } {
...
\CDR@Debug{Debug.CDR.provided.C:\CDR_tag_module:n { default } / #1 = ...}
    }
  }
}
\RenewDocumentCommand \CDRSet { m } {
\CDR@Debug{ Debug.CDRSet:#1/}
...
\CDR@Debug{ Debug.CDRSet.1:##1/\l_CDR_kv_clist/ }
  }
  \CDR_tag_keys_set_known:nVN { .. } \l_CDR_kv_clist \l_CDR_kv_clist
\CDR@Debug{ Debug.CDRSet.2:\CDR_tag_module:n { .. }//\l_CDR_kv_clist/ }
  \CDR_tag_provide_from_kv:V \l_CDR_kv_clist
\CDR@Debug{ Debug.CDRSet.2a:\CDR_tag_module:n { .. }//\l_CDR_kv_clist/ }  
  \CDR_tag_keys_set_known:nVN { .. } \l_CDR_kv_clist \l_CDR_kv_clist
  
  \keys_if_exist:nnTF { CDR@Tags } { tag/default/falbala~engine~options } { \typeout{ SUCCESS } } { \typeout{ FAILURE } }
  
  
  
\CDR@Debug{ Debug.CDRSet.3:\CDR_tag_module:n { .. }//\l_CDR_kv_clist/ }
  \CDR_tag_keys_set:nV { default } \l_CDR_kv_clist
\CDR@Debug{ Debug.CDRSet.4:\CDR_tag_module:n { default } /\l_CDR_kv_clist/ }
