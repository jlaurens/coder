...
%    \begin{MacroCode}
  ...
  \CDR_tag_if_eq:cnTF { numbers } { none } {
    \tl_set:Nn \l_CDR_tl { { \typeout{DEBUG_TRUE.........}prg_return_true: } }
  } {
    \tl_set:Nn \l_CDR_tl { { \typeout{DEBUG_TRUE.........}prg_return_false: } }
  }
  \exp_args:NNnV
...
%    \begin{MacroCode}
  ...
  \CDR_tag_if_eq:cnTF { numbers } { none } {
    ...
    \tl_set:Nn \l_CDR_tl { \typeout{DEBUG_FALSE.........}{ prg_return_false: } }
  }
  \exp_args:NNnV
  \prg_set_conditional:Nnn \CDR_if_numbering: { p, T, F, TF } \l_CDR_tl
