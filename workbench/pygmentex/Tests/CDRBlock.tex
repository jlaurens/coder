...
%    \begin{MacroCode}
  ...
  \CDR_tag_get:cN { tags } \l_CDR_tags_clist
  \clist_if_empty:NTF \l_CDR_tags_clist {
    ...
    \clist_gset_eq:NN \g_CDR_tags_clist \l_CDR_tags_clist
  }
  \lua_now:n {
...
%    \begin{MacroCode}  
    ...
    \CDR@StyleIfExist { \l_CDR_tl } {
      \typeout { ALREADY~STYLE:~\l_CDR_tl}
      \CDR@StyleUseTag
    } {
      \typeout { LOOKING~FOR:~\l_CDR_tl}
