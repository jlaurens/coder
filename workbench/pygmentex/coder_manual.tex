...
Code chunks are put in a \texttt{CDRBlock} \LaTeX{} environment. Like many verbatim envitonments, the closing command is a full line containing literally \CDRCode[lang=tex]|\end{CDRBlock}|, any material before being ignored.
