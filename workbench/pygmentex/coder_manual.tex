...
\CDRCodeSave{CDRNumberMain}|\CDRNumberMain|
\CDRCodeSave{CDRNumberOther}|\CDRNumberOther|
...
%%%%%
\begin{figure}[h!]
\begin{centabu}{p{0.45\linewidth}p{0.05\linewidth}|p{0.05\linewidth}p{0.45\linewidth}}
...
\item[{%
\CDRCodeUse[tags=src]{CDRNumberMain},
\CDRCodeUse{CDRNumberOther},
}]
...
] allow to define commands similar to \CDRCodeUse{CDRCode} with a different name, see section \ref{sect:custom}.
\itemtt[
\CDRCodeUse{CDRBlockNewEnvironment},
\CDRCodeUse{CDRBlockRenewEnvironment}
] allow to define environments similar to  \CDRCodeUse{CDRBlock} with a different name, see section \ref{sect:custom}.
\end{description}
...
\CDRSet{numbers=none}
\begin{centabu}{p{0.345\linewidth}|p{0.645\linewidth}}
\begin{CDRBlock}[
  lang=tex,
  tags=latex,
  no space,
...
\begin{figure}[H]
\begin{centabu}{p{0.45\linewidth}p{0.1\linewidth}p{0.45\linewidth}}
\begin{CDRBlock}[tags=lua, no space]
...
%
\section{Export code with \CDRCodeUse{CDRBlockExport}}
...
\begin{centabu}{p{0.5\columnwidth}p{0.5\columnwidth}}
%
\begin{CDRBlock}[tags=src, no space]
\begin{⟨CDRBlock⟩}[
  tags=X,
...
\end{CDRBlockSave}
\end{centabu}
Blocks with the same leftmost tag can be numbered continuously with option \CDRCode[tags=src]|first number=last|, the next one starting just after the previous has stopped.
\begin{centabu}{p{0.6\columnwidth}p{0.4\columnwidth}}
%
\begin{CDRBlock}[
  tags=src,
  no space,
...
\end{centabu}
%
Above, the intermediate line numbers were displayed by the \CDRCode[tags=src]|number other| instructions that display the argument in light gray.
Similarly, the \CDRCode[tags=src]|number main| instructions display the main line numbers with the help of the \pkg{mboxfill} package:
\begin{CDRBlock}[tags=src]
number main={%
  \color{⟨\MyMeta{color}⟩}
  \bfseries#1
...
\begin{centabu}{p{0.333\columnwidth}p{0.333\columnwidth}p{0.333\columnwidth}}
...
\begin{centabu}{p{0.5\linewidth}p{0.5\linewidth}}
\begin{CDRBlock}[
  tags=src,
  ref label=My,
  no space,
...
%
\section{Import documented code with \CDRCodeUse[tags=src]{CDRBlockImport}}
...
Initially empty. For example on the right with option \CDRCode[tags=options]|format=\color{green!30!black}\bfseries| on the right:
\begin{centabu}{p{0.5\linewidth}p{0.5\linewidth}}
\begin{CDRBlock}[no space above, no space below]
This is default.
\end{CDRBlock}
&
\begin{CDRBlock}[
  format=\color{green!20!black}\bfseries,
  no space,
]
This is dark green and bold.
\end{CDRBlock}
\end{centabu}
The \CDRCode|\color| command adds a vertical space: it is a ``feature'' of \LaTeX.
%
