...
This Lua\LaTeX\ package is available on CTAN and a part of any standard \TeX{} distribution\footnote{In progress}. To use it in a document, put the next instruction in the preamble:
...
\meta{tag} is subject to minor restrictions (section \ref{sect:tags}).
%%%%% __engine
...
when the engine named \meta{engine name} is selected, see section \ref{sect:frames}.
