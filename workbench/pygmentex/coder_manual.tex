...
\end{tabular}
\end{center}
When used in itemize and enumerate lists or similar environments, the \CDRCode|CDRBlock| environment ignores the indentation. With option \CDRCode[tags=options]|list indent=false| it adapts its width to the indentation as occurs on the right:
\begin{center}
\begin{CDRBlockSave}{}
...
\end{minipage}
&
\CDRSet{list indent=false,show tags=none}
\begin{minipage}[t]{0.85\linewidth}
\CDRBlockUse[tags=latex]{}
\begin{itemize}
\item One
