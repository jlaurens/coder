...
] allow to define commands and environment similar to \CDRCodeUse{CDRCode} and \CDRCodeUse{CDRBlock} with a different name, see section \ref{sect:custom}.
\end{description}
...
\CDRBlockUse[lang=tex,tags=latex]{}
\end{minipage}%
...
and the suffix of line 4 goes here\tikzmark{from suffix 4}.
...
\setlength{\tabcolsep}{0pt}
\begin{tabular}{p{0.5\linewidth}p{0.5\linewidth}}
\CDRBlockUse[tags=src, escape inside=⟨⟩]{1}
&
which output simply reads
\CDRBlockUse[
  numbers=left,
...
Here is the difference between slanted with \CDRCode|font shape=\slshape| and italic with  \CDRCode|font shape=\itshape|.
\begin{center}
\setlength{\tabcolsep}{0mm}
\begin{tabular}{p{0.5\linewidth}p{0.5\linewidth}}
...
\begin{minipage}[t]{0.85\linewidth}
\CDRSet{show tags=none,show spaces}
\begin{CDRBlock}[tags=latex,pygments=true]
\textbf{In	eu	orci	massa}
\end{CDRBlock}
\end{minipage}
&
\CDRSet{show tags=none,show spaces}
\begin{minipage}[t]{0.85\linewidth}
\begin{CDRBlock}[tags=latex,pygments=false]
\textbf{In	eu	orci	massa}
\end{CDRBlock}
\end{minipage}
\end{tabular}
...
\setlength{\tabcolsep}{0mm}
\begin{tabular}{p{0.5\linewidth}p{0.5\linewidth}}
\CDRSet{show tags=none,show spaces,tab size=2}
\begin{CDRBlock}[tags=latex,pygments=true,no spaces above]
In	eu	orci	massa
\end{CDRBlock}
&
\CDRSet{show tags=none,show spaces,tab size=3}
\begin{CDRBlock}[tags=latex,pygments=false,no spaces above]
In	eu	orci	massa
\end{CDRBlock}
\end{tabular}
\end{center}
