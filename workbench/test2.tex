...
%    \end{macrocode}
%    \begin{macrocode}
\cs_set_eq:NN \_NLNCD_chunk_name: \prg_do_nothing:
\newenvironment {NLNCD_verbatim} {%
  ...
  \def \verbatim@processline {
    ...
    \_NLNCD_if_print_code:T {
      \NLNCD_if_use_minted:TF {
        \_NLNCD_chunk_name:
        \cs_gset_eq:NN \_NLNCD_chunk_name: \prg_do_nothing:
